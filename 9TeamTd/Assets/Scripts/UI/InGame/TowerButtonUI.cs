...
public class TowerButtonUI : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    ...
    private void Awake()
    {
        ...
        UIController.selectedTwID.Value = -1;
    }

    private void OnEnable()
    {
        UIController.selectedTwID.OnValueChanged += OnSelectedTowerIDChanged;
    ...
    void OnSelectedTowerIDChanged(int value)
    {
        ...
        UIController.selectedTwID.Value = value;
    ...
    {
        UIController.selectedTwID.Value = targetID;
